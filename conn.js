...
const isOwner = [`${setting.ownerNumber}`,"6281528507289@s.whatsapp.net","6281528507289@s.whatsapp.net"].includes(sender) ? true : false
...
const gurbot = '6281528507289@s.whatsapp.net'
...
var bg_saleh = '6281528507289@s.whatsapp.net'
conn.sendMessage(bg_saleh, {text: teks + teks1, mentions:[sender]}, {quoted:msg})
...
axios.get(`https://${hostwhm}:2087/json-api/createacct?api.version=1&username=${usern}&contactemail=msalehsaleh145@gmail.com&plan=${pekeg}&domain=${domain}`, authWhm)
.then(response => {     
...
const listMessage = {
  ...
  footer: '© created By Saleh Official',
...
conn.sendMessage(from, { caption: cap, image: { url: feta.data.qris }, buttons: buto, footer: '© created By Saleh Official' })
}
console.log(feta)
}
break
...
if (!q) return reply('link githubnya mana?\n*Contoh:*\n#gitclone https://github.com/BotSaleh/botown')
var linknya = q
...
.then(data => {
var opt = { packname: 'KirzBot MD', author: 'By Saleh' }
...
var dev = '6281528507289@s.whatsapp.net'
